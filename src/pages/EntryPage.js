  ...
  return (
    <View style={middleContentStyle}>
      ...
      <View style={[profileFlexWrapper, extraStyle]}>
        <UserComp picture={adminPic} text="Admin" navigation={navigation} />
        <UserComp picture={teacherPic} text="Teacher" navigation={navigation} />
      </View>
      <View style={bottomUser}>
        <UserComp picture={studentPic} text="Student" navigation={navigation} />
      </View>
    </View>
  );
};
